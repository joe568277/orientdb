...
public abstract class OAbstractPaginatedStorage extends OStorageAbstract
    ...
    try {
      ...
      if (!configuration.getContextConfiguration().getContextKeys()
        ...
        configuration.getContextConfiguration()
            .setValue(OGlobalConfiguration.STORAGE_COMPRESSION_METHOD, OGlobalConfiguration.STORAGE_COMPRESSION_METHOD.getValue());
  ...
  public void commit(final OTransaction clientTx, Runnable callback) {
        ...
        try {
          ...
          try {
            ...
            if (callback != null) {
              ...
              OLogManager.instance().info(this, "Starting callback.run()");
              callback.run();
              OLogManager.instance().info(this, "Finished callback.run() in %dms", System.currentTimeMillis() - callbackStart);
            }
    ...
    OLogManager.instance().info(this, "Finished commit in %dms", System.currentTimeMillis()-startTime);
  }
